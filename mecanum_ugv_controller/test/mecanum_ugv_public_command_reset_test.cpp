...
TEST(MecanumPublicCommandReset, PublicCommandEntersAndHoldsResetFromReadyAndCustom1) {
    ros::NodeHandle nh;
    ...
    ros::Publisher reference_pub =
        nh.advertise<geometry_msgs::TwistStamped>("/ugv_test/alg/reference/twist", 10);
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "mecanum_ugv_public_command_reset_test");
